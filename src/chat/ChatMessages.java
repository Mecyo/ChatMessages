...
public class ChatMessages extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 37053412342033186L;
    ...
    private void buttonEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEnviarActionPerformed
        if(cliente.getConexao().isClosed()){
        	areaMensagens.setText(areaMensagens.getText() + "É necessário se conectar a um servidor para enviar mensagens!\n");
        }else{
...
private void buttonDesconectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConectarActionPerformed
        
        try {
        	if(cliente.getConexao().isConnected()){
        		cliente.getConexao().close();
        		areaMensagens.setText("Desconectado do servidor.\n");
        	}
		} catch (IOException e) {
			e.printStackTrace();
		}
