...
public class TelaCliente extends JFrame implements ActionListener {
	...
	TelaCliente(String host, int porta) {
		...
		serverAndPort.add(new JLabel("Endere�o do Servidor:  "));
		serverAndPort.add(tfServidor);
		serverAndPort.add(new JLabel(" N�mero da porta:  "));
		serverAndPort.add(tfPorta);
		serverAndPort.add(new JLabel(""));
		PainelNorte.add(serverAndPort);

		lblDigiteSeuNome = new JLabel("Digite seu nome de usu�rio abaixo", SwingConstants.CENTER);
		PainelNorte.add(lblDigiteSeuNome);
		tf = new JTextField("An�nimo");
		...
		quemEstaOnline = new JButton("Quem est� online");
	...
	void connectionFailed() {
		...
		logout.setEnabled(false);
		quemEstaOnline.setEnabled(false);
		lblDigiteSeuNome.setText("Digite seu nome de usu�rio abaixo");
		tf.setText("An�nimo");
