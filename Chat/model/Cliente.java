...
public class Cliente  {
	...
	public Cliente(String servidor, int porta, String nomeUsuario) {
		this(servidor, porta, nomeUsuario, null);
	}
	public Cliente(String servidor, int porta, String nomeUsuario, TelaCliente tc) {
	...
	public class EscutandoDoServidor extends Thread {
